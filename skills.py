...
# this would be the place to use the min function after we learn the min function
...
def largest_int(number_list):
    ...
    # this would be the place to use max function! At a later date. When we learn it. 
...
def sum_numbers(number_list):
    ...
    """
    #look at line 47 for pseudo code ish
...
#reminder to come back and look at this next week
#when it will probably make more sense
